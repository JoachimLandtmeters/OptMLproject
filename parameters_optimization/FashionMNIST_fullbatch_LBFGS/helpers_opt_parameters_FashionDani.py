...
def hyperparameters_tuning_LBFGS_minibatch(trainset, valset, batchsize_grid, history_size_grid, epochs, model_NN, fullbatch=False,line_search=True):
    ...
    for bs in batchsize_grid:
        ...
        for hs in history_size_grid:
            ...
            if model_NN=="FCNN":
                ...
                if fullbatch:
                    max_iterations=20
                optimizer=optim.LBFGS(model.parameters(),max_iter=max_iterations,history_size=hs, line_search_fn='strong_wolfe')
                ...
                if line_search==False:
                    linesearch=None
                optimizer=optim.LBFGS(model.parameters(),max_iter=max_iterations,history_size=hs,line_search_fn=linesearch)
